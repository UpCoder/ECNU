...
def run_cam():
    ...
    #     os.path.join(current_path, '24Output-2x128-17epochs_right.h5')
    #     # classifier_path / (classifier_name + "_right.h5")
    # )
    left_hand_classifier = tf.keras.models.load_model(
        os.path.join(current_path, '24Output-2x128-17epochs_left.h5')
        # classifier_path / (classifier_name + "_left.h5")
    )
    hand_classifiers = (left_hand_classifier, )
    ...
    classifier_labels = ["0", "1", "2", "2_bis", "3", "3_bis", "4", "5", "Chef", "Help", "Super", "VIP", "Water",
                         "Metal", "Dislike", "Loser", "Phone", "Shaka", "Stop", "Vulcan_Salute", "Power_Fist", "Horns",
                         "Fight_Fist", "Middle_Finger"]
    ...
    while camera.video_capure.isOpened():
        ...
        # print(f'hand_keypoints: {hand_keypoints}')
        ...
        if type(hand_data) != type(None):
            ...
            print(f'prediction_probabilities: {prediction_probabilities}')
